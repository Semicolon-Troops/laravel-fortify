        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <img src="{{ asset('assets/favicon.png') }}" alt="logo" width="80"
                            class="shadow-dark rounded-circle mb-5 mt-2">
                        <h4 class="text-success font-weight-normal">
                            <span class="font-weight-bold">Laravel Fortify
                            </span>
                        </h4>
                        <p class="text-muted">Laravel Fortify adalah implementasi backend otentikasi agnostik frontend
                            untuk Laravel
                        </p>
